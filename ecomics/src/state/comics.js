...
export const getComicsRequest = createAsyncThunk("COMICS", async(title) => {
    ...
    return  await axios.get(`https://gateway.marvel.com/v1/public/comics?ts=1&format=comic&formatType=comic&title=${title}&apikey=e121962b2f2979ad43d0854ba839ec8c&hash=6715ac36ab30c15efdf476a60a490ae8`).then((r) => r.data).then((comics)=> (comics.data.results));
  });
